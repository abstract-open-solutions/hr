odoo.define('hr_holidays_default_time.leave_defaults', function (require) {
"use strict";

var CalendarView = require('web_calendar.CalendarView');
var time = require('web.time');

var LeavesCalendarView = CalendarView.include({
	get_event_data: function(event) {
        ...
        if (event.allDay) {
            ...
            if (this.all_day) {
                ...
                date_stop_day = new Date(event_end.getFullYear(),event_end.getMonth(),event_end.getDate(),18);
            }
